...
public class AuthActivity extends AppCompatActivity
        ...
        RegistroFragment.OnRegistroInteractionListener, RememberFragment.OnRememberFagmentInteraction {
    ...
    @Override
    public void irARemember() {
        FragmentTransaction transaction =
                getSupportFragmentManager().beginTransaction();

        transaction.replace(R.id.frameAuthActivity, RememberFragment.newInstance());
        transaction.commit();
    }
